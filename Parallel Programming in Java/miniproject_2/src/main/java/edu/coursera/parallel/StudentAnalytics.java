...
public final class StudentAnalytics {
    ...
    public double averageAgeOfEnrolledStudentsParallelStream(
        ...
        double avgSum = Stream.of(studentArray).parallel().filter(student -> student.checkIsCurrent()).mapToDouble(student -> student.getAge()).average().getAsDouble();
        return avgSum;
    }
    ...
    public String mostCommonFirstNameOfInactiveStudentsParallelStream(
            final Student[] studentArray) {
        //throw new UnsupportedOperationException();
        Stream<Student> activeStudent = Stream.of(studentArray).filter(student -> !(student.checkIsCurrent()));
        Map<String, Long> map = activeStudent.parallel().collect(Collectors.groupingBy(Student::getFirstName, Collectors.counting()));
